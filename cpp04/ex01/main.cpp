...
int main()
{
	...
	std::cout << std::endl
		...
		<< RESET << std::endl << std::endl;
	{
		Animal* teddy = new Cat();
		std::cout << std::endl;

		Animal* cpy_teddy = new Cat(*dynamic_cast<Cat*>(teddy));
		std::cout << std::endl;
		...
		<< RESET << std::endl << std::endl;
	{
		...
		Animal* cpy_bean = new Dog(*dynamic_cast<Dog*>(bean));
		std::cout << std::endl;
		...
		<< RESET << std::endl << std::endl;
	{
		...
		Animal no_assign_group[2];
		std::cout << std::endl;
		
		std::cout << "after var declarations..." << std::endl;
		
		no_assign_group[1].makeSound();
